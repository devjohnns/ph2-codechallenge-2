...
import { initialGoals } from './data/currentGoal';
import './App.css';
  ...
  return (
    <div className="App">
      <header className="App-header">
        <h1><b><i>ODIWOR'S SMART GOAL PLANNER</i></b></h1>
      ...
      <footer className="App-footer">
        <p>© 2025 Smart Goal Planner - <b><i>TRACK YOUR FINANCIAL GOALS WITH ODIWOR'S TRACKER</i></b></p>
      </footer>
    </div>
  );
}
